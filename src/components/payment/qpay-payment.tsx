...
export function QPayPayment({ qrImage, bankUrls = [], amountMnt }: QPayPaymentProps) {
  const isMobile = useIsMobile();

  return (
    <div className="mt-8 px-2">
      <div className="text-center">
        <p className="font-medium mb-1">QPay-ээр төлөх</p>
        ...
        {!isMobile && (
          <p className="mt-4 text-sm text-muted-foreground">
            Утасны банкны аппаар энэ QR кодыг уншуулна уу
          </p>
        )}
      </div>
